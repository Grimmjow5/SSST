...
class ReportsController extends Flight {
    ...
    public function GeneratePDF() {
       ...
       $pdf->stream("RepRiesgo{$hoy}.pdf",array("Attachment"=> false));
    ...
    public function GenerateExcel(){
        ...
        $headExcel = ['No','Fecha reportado','Descripción','Prioridad','Fecha de Solución','Descripcion de Solucion','Subarea','Area'];
        $this->ValidateRequest($_REQUEST);
        $report = $this->factory->reportes->GetReports($this->modelRiesgo);
        ...
        header("Content-Disposition: attachment;filename=ReporteRigGenerado{$hoy}.xlsx");
