...
<div class="d-flex flex-column p-2 w-100">
          ...
          <label for="formGroupExampleInput" class="form-label">Subarea</label>
            <select class="form-select" id="subarea" name="subarea">
              ...
              ?>
                    ...
                    <button type="submit" class="btn btn-success mt-3" name="add" id="add">
    ...
    <div class="pt-3 mt-2 mx-4">
        <div class="bg-light p-4 shadow-lg">
          ...
          <h4 class="my-1">Registros de extintores</h4>
          <small>Reportes de condición de extintor</small>

        <table id="tableReportE" class="display w-100" >
            <thead>
                <tr>    
                    <th>No</th>
                    <th>Fecha Reg</th>
